...
int16x4x2_t test_vzip_s16(int16x4_t a, int16x4_t b) {
  ...
  // LLVM: [[A_CAST:%.*]] = bitcast <8 x i8> [[A_RAW]] to <4 x i16>
  // LLVM: [[B_CAST:%.*]] = bitcast <8 x i8> [[B_RAW]] to <4 x i16>
  // LLVM: [[VZIP_LO:%.*]] = shufflevector <4 x i16> [[A_CAST]], <4 x i16> [[B_CAST]], <4 x i32> <i32 0, i32 4, i32 1, i32 5>
  // LLVM: [[VZIP_HI:%.*]] = shufflevector <4 x i16> [[A_CAST]], <4 x i16> [[B_CAST]], <4 x i32> <i32 2, i32 6, i32 3, i32 7>
...
int32x2x2_t test_vzip_s32(int32x2_t a, int32x2_t b) {
  ...
  // LLVM: [[A_CAST:%.*]] = bitcast <8 x i8> [[A_RAW]] to <2 x i32>
  // LLVM: [[B_CAST:%.*]] = bitcast <8 x i8> [[B_RAW]] to <2 x i32>
  // LLVM: [[VZIP_LO:%.*]] = shufflevector <2 x i32> [[A_CAST]], <2 x i32> [[B_CAST]], <2 x i32> <i32 0, i32 2>
  // LLVM: [[VZIP_HI:%.*]] = shufflevector <2 x i32> [[A_CAST]], <2 x i32> [[B_CAST]], <2 x i32> <i32 1, i32 3>
...
float32x2x2_t test_vzip_f32(float32x2_t a, float32x2_t b) {
  ...
  // LLVM-SAME: <2 x float> {{.*}} [[A:%.*]], <2 x float> {{.*}} [[B:%.*]]) {{.*}} {
  // LLVM: [[VZIP_LO:%.*]] = shufflevector <2 x float> {{.*}}, <2 x float> {{.*}}, <2 x i32> <i32 0, i32 2>
  // LLVM: [[VZIP_HI:%.*]] = shufflevector <2 x float> {{.*}}, <2 x float> {{.*}}, <2 x i32> <i32 1, i32 3>
...
int16x8x2_t test_vzipq_s16(int16x8_t a, int16x8_t b) {
  ...
  // LLVM: [[A_CAST:%.*]] = bitcast <16 x i8> [[A_RAW]] to <8 x i16>
  // LLVM: [[B_CAST:%.*]] = bitcast <16 x i8> [[B_RAW]] to <8 x i16>
  // LLVM: [[VZIP_LO:%.*]] = shufflevector <8 x i16> [[A_CAST]], <8 x i16> [[B_CAST]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  // LLVM: [[VZIP_HI:%.*]] = shufflevector <8 x i16> [[A_CAST]], <8 x i16> [[B_CAST]], <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
...
int32x4x2_t test_vzipq_s32(int32x4_t a, int32x4_t b) {
  ...
  // LLVM: [[A_CAST:%.*]] = bitcast <16 x i8> [[A_RAW]] to <4 x i32>
  // LLVM: [[B_CAST:%.*]] = bitcast <16 x i8> [[B_RAW]] to <4 x i32>
  // LLVM: [[VZIP_LO:%.*]] = shufflevector <4 x i32> [[A_CAST]], <4 x i32> [[B_CAST]], <4 x i32> <i32 0, i32 4, i32 1, i32 5>
  // LLVM: [[VZIP_HI:%.*]] = shufflevector <4 x i32> [[A_CAST]], <4 x i32> [[B_CAST]], <4 x i32> <i32 2, i32 6, i32 3, i32 7>
...
float32x4x2_t test_vzipq_f32(float32x4_t a, float32x4_t b) {
  ...
  // LLVM-SAME: <4 x float> {{.*}} [[A:%.*]], <4 x float> {{.*}} [[B:%.*]]) {{.*}} {
  // LLVM: [[VZIP_LO:%.*]] = shufflevector <4 x float> {{.*}}, <4 x float> {{.*}}, <4 x i32> <i32 0, i32 4, i32 1, i32 5>
  // LLVM: [[VZIP_HI:%.*]] = shufflevector <4 x float> {{.*}}, <4 x float> {{.*}}, <4 x i32> <i32 2, i32 6, i32 3, i32 7>
