...
enum class TailFoldingPolicyTy { None = 0, PreferFoldTail, MustFoldTail, PredicatedEpilogue };
...
static cl::opt<TailFoldingPolicyTy> TailFoldingPolicy(
    ...
    cl::values(
        ...
        clEnumValN(TailFoldingPolicyTy::MustFoldTail, "must-fold-tail",
                   ...
                   "tail-folding fails."),
        clEnumValN(TailFoldingPolicyTy::PredicatedEpilogue, "predicated-epilogue",
