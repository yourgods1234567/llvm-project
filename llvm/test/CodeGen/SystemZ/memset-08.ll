...
;
; Test memsets of some small constant lengths within the (16, 32] range that
; should be done with VL combinations if aligned, or with MVC otherwise.
...
; CHECK-NEXT:    br %r14
  call void @llvm.memset.p0.i64(ptr align 2 %Dst, i8 %val, i64 18, i1 false)
  ret void
}
...
; CHECK-NEXT:    mvc 1(17,%r2), 0(%r2)
; CHECK-NEXT:    br %r14
  call void @llvm.memset.p0.i64(ptr align 2 %Dst, i8 -1, i64 18, i1 false)
  ret void
}
