...
;
; Test memmoves of some small constant lengths that should be done either
...
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 2 %Dst, ptr align 2 %Src, i64 1, i1 false)
  ret void
}
...
; CHECK-NEXT:    sth %r0, 0(%r3)
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 2 %Dst, ptr align 2 %Src, i64 3, i1 false)
  ret void
}
...
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 4 %Dst, ptr align 4 %Src, i64 4, i1 false)
  ret void
}
...
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 2 %Dst, ptr align 4 %Src, i64 4, i1 false)
  ret void
}
...
; CHECK-NEXT:    st %r0, 0(%r3)
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 4 %Dst, ptr align 4 %Src, i64 5, i1 false)
  ret void
}
...
; CHECK-NEXT:    st %r0, 0(%r3)
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 4 %Dst, ptr align 4 %Src, i64 6, i1 false)
  ret void
}
...
; CHECK-NEXT:    lmg %r14, %r15, 272(%r15)
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 4 %Dst, ptr align 4 %Src, i64 7, i1 false)
  ret void
}
...
; CHECK-NEXT:    lmg %r14, %r15, 272(%r15)
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 8 %Dst, ptr align 4 %Src, i64 17, i1 false)
  ret void
}
...
; CHECK-NEXT:    lmg %r14, %r15, 272(%r15)
; CHECK-NEXT:    br %r14
  call void @llvm.memmove.p0.p0.i64(ptr align 2 %Dst, ptr align 8 %Src, i64 18, i1 false)
  ret void
}
