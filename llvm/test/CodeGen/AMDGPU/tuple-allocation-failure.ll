...
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[84:85], 1, v3
...
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s68, 8
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s69, 9
...
; GLOBALNESS1-NEXT:  ; %bb.6: ; %LeafBlock13
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s55, 1
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS1-NEXT:  .LBB1_7: ; %Flow27
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
...
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS1-NEXT:  .LBB1_9: ; %Flow26
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], -1
...
; GLOBALNESS1-NEXT:  .LBB1_14: ; %Flow17
...
; GLOBALNESS0-NEXT:  ; %bb.6: ; %LeafBlock13
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s55, 1
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:  .LBB1_7: ; %Flow27
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
...
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:  .LBB1_9: ; %Flow26
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], -1
...
; GLOBALNESS0-NEXT:  .LBB1_14: ; %Flow17
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_add_u32 s82, s48, 40
; GLOBALNESS0-NEXT:    s_addc_u32 s83, s49, 0
; GLOBALNESS0-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS0-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS0-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
...
; GLOBALNESS0-NEXT:  .LBB1_24: ; %Flow24
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
