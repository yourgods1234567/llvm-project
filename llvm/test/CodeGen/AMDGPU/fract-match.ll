...
; IR-NEXT:    [[FLOOR:%.*]] = tail call float @llvm.floor.f32(float [[X]])
; IR-NEXT:    [[SUB:%.*]] = fsub float [[X]], [[FLOOR]]
; IR-NEXT:    [[MIN:%.*]] = tail call nsz float @llvm.minimum.f32(float [[SUB]], float f0x3F7FFFFF)
; IR-NEXT:    ret float [[MIN]]
;
...
; IR-NEXT:    [[CMP:%.*]] = fcmp oge float [[SUB1]], f0x3F7FFFFF
; IR-NEXT:    [[COND:%.*]] = select i1 [[CMP]], float f0x3F7FFFFF, float [[SUB1]]
...
; IR-NEXT:    store float [[CALL]], ptr addrspace(1) [[IPTR]], align 4
; IR-NEXT:    [[SUB1:%.*]] = fsub float [[X]], [[CALL]]
; IR-NEXT:    [[CMP:%.*]] = fcmp ogt float [[SUB1]], f0x3F7FFFFF
; IR-NEXT:    [[COND:%.*]] = select i1 [[CMP]], float f0x3F7FFFFF, float [[SUB1]]
; IR-NEXT:    [[FABS_X:%.*]] = call float @llvm.fabs.f32(float [[X]])
; IR-NEXT:    [[NOT_INF:%.*]] = fcmp une float [[FABS_X]], +inf
; IR-NEXT:    [[COND6:%.*]] = select i1 [[NOT_INF]], float [[COND]], float 0.000000e+00
...
; IR-NEXT:    store float [[CALL]], ptr addrspace(1) [[IPTR]], align 4
; IR-NEXT:    [[SUB1:%.*]] = fsub float [[X]], [[CALL]]
; IR-NEXT:    [[MIN:%.*]] = call float @llvm.minimum.f32(float [[SUB1]], float f0x3F7FFFFF)
; IR-NEXT:    [[FABS_X:%.*]] = call float @llvm.fabs.f32(float [[X]])
; IR-NEXT:    [[NOT_INF:%.*]] = fcmp une float [[FABS_X]], +inf
...
; IR-NEXT:    [[OGE_MIN_CONST:%.*]] = fcmp oge float [[SUB_FLOOR]], f0x3F7FFFFF
; IR-NEXT:    [[SELECT:%.*]] = select i1 [[OGE_MIN_CONST]], float f0x3F7FFFFF, float [[SUB_FLOOR]]
...
; IR-NEXT:    [[FLOOR:%.*]] = call float @llvm.floor.f32(float [[X]])
; IR-NEXT:    [[SUB_FLOOR:%.*]] = fsub float [[X]], [[FLOOR]]
; IR-NEXT:    [[MIN:%.*]] = call float @llvm.minimum.f32(float [[SUB_FLOOR]], float f0x3F7FFFFF)
; IR-NEXT:    ret float [[MIN]]
  %floor = call float @llvm.floor.f32(float %x)
  %sub.floor = fsub float %x, %floor
...
; IR-NEXT:    [[OGE_MIN_CONST:%.*]] = fcmp oge <2 x float> [[SUB_FLOOR]], <float f0x3F7FFFFF, float poison>
; IR-NEXT:    [[SELECT:%.*]] = select <2 x i1> [[OGE_MIN_CONST]], <2 x float> <float f0x3F7FFFFF, float poison>, <2 x float> [[SUB_FLOOR]]
...
; IR-NEXT:    [[FLOOR:%.*]] = call <2 x float> @llvm.floor.v2f32(<2 x float> [[X]])
; IR-NEXT:    [[SUB_FLOOR:%.*]] = fsub <2 x float> [[X]], [[FLOOR]]
; IR-NEXT:    [[MIN:%.*]] = call <2 x float> @llvm.minimum.v2f32(<2 x float> [[SUB_FLOOR]], <2 x float> <float f0x3F7FFFFF, float poison>)
