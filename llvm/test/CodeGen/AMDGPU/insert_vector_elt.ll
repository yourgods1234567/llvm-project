...
; SI-NEXT:    s_xor_b32 s9, s1, 0x50005
; SI-NEXT:    s_xor_b32 s8, s0, 0x50005
; SI-NEXT:    s_lshl_b64 s[2:3], 0xffff, s2
; SI-NEXT:    s_and_b64 s[2:3], s[8:9], s[2:3]
; SI-NEXT:    s_xor_b64 s[0:1], s[2:3], s[0:1]
...
; VI-NEXT:    s_lshl_b64 s[2:3], 0xffff, s2
; VI-NEXT:    s_xor_b64 s[8:9], s[0:1], s[8:9]
; VI-NEXT:    s_and_b64 s[2:3], s[8:9], s[2:3]
