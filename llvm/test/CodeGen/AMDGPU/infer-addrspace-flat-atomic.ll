...
; CHECK-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x2c
...
; CHECK-NEXT:    global_atomic_add_f64 v0, v[2:3], s[2:3]
...
; CHECK-NEXT:    s_cselect_b32 s4, s2, -1
