...
; GFX12-GI-NEXT:    v_mov_b32_e32 v1, v0
; GFX12-GI-NEXT:    v_mov_b32_e32 v3, v2
; GFX12-GI-NEXT:    s_setpc_b64 s[30:31]
    %x = call <4 x i1> @llvm.fptosi.sat.v4f16.v4i1(<4 x half> %f)
    ret <4 x i1> %x
}
...
; GFX12-GI-NEXT:    v_med3_i16 v0.l, v0.l, -1, 0
; GFX12-GI-NEXT:    v_med3_i16 v2.l, v0.h, -1, 0
; GFX12-GI-NEXT:    v_med3_i16 v4.l, v1.l, -1, 0
; GFX12-GI-NEXT:    v_med3_i16 v6.l, v1.h, -1, 0
; GFX12-GI-NEXT:    v_mov_b32_e32 v1, v0
; GFX12-GI-NEXT:    v_mov_b32_e32 v3, v2
; GFX12-GI-NEXT:    v_mov_b32_e32 v5, v4
; GFX12-GI-NEXT:    v_mov_b32_e32 v7, v6
; GFX12-GI-NEXT:    s_setpc_b64 s[30:31]
    %x = call <8 x i1> @llvm.fptosi.sat.v8f16.v8i1(<8 x half> %f)
    ret <8 x i1> %x
}
...
; GFX12-GI-NEXT:    v_med3_i16 v0.l, v0.l, v0.h, 0x7f
; GFX12-GI-NEXT:    v_med3_i16 v2.l, v1.l, v0.h, 0x7f
; GFX12-GI-NEXT:    v_med3_i16 v4.l, v1.h, v0.h, 0x7f
; GFX12-GI-NEXT:    v_med3_i16 v6.l, v2.h, v0.h, 0x7f
; GFX12-GI-NEXT:    v_mov_b32_e32 v1, v0
; GFX12-GI-NEXT:    v_mov_b32_e32 v3, v2
; GFX12-GI-NEXT:    v_mov_b32_e32 v5, v4
; GFX12-GI-NEXT:    v_mov_b32_e32 v7, v6
