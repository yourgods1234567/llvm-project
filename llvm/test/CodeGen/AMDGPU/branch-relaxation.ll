...
; GCN-NEXT:    s_add_u32 s10, s10, (.LBB10_2-.Lpost_getpc12)&4294967295
; GCN-NEXT:    s_addc_u32 s11, s11, (.LBB10_2-.Lpost_getpc12)>>32
...
; GCN-NEXT:    s_and_b64 s[10:11], s[12:13], s[10:11]
; GCN-NEXT:  .LBB10_4: ; %Flow6
; GCN-NEXT:    s_andn2_b64 vcc, exec, s[10:11]
; GCN-NEXT:    s_cbranch_vccz .LBB10_5
; GCN-NEXT:  ; %bb.10: ; %Flow6
; GCN-NEXT:    s_getpc_b64 s[0:1]
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s10, s10, (.LBB10_2-.Lpost_getpc11)&4294967295
; GFX11-NEXT:    s_addc_u32 s11, s11, (.LBB10_2-.Lpost_getpc11)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
...
; GFX11-NEXT:    s_and_b64 s[0:1], s[8:9], s[0:1]
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    s_lshl_b64 s[2:3], s[6:7], 2
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s12, s12, (.LBB10_4-.Lpost_getpc17)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s13, s13, (.LBB10_4-.Lpost_getpc17)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[12:13]
; GFX12-NEXT:  .LBB10_1: ; %Flow
; GFX12-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s9
; GFX12-NEXT:    s_cbranch_vccnz .LBB10_2
; GFX12-NEXT:  ; %bb.10: ; %Flow
; GFX12-NEXT:    s_getpc_b64 s[10:11]
; GFX12-NEXT:  .Lpost_getpc13:
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s10, s10, (.LBB10_5-.Lpost_getpc13)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_5-.Lpost_getpc13)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[10:11]
; GFX12-NEXT:  .LBB10_2: ; %Flow6
; GFX12-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
; GFX12-NEXT:    s_cbranch_vccz .LBB10_3
; GFX12-NEXT:  ; %bb.12: ; %Flow6
; GFX12-NEXT:    s_getpc_b64 s[0:1]
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s10, s10, (.LBB10_2-.Lpost_getpc15)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_2-.Lpost_getpc15)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[10:11]
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s10, s10, (.LBB10_3-.Lpost_getpc16)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_3-.Lpost_getpc16)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[10:11]
; GFX12-NEXT:  .LBB10_6:
...
; GFX12-NEXT:    s_lshl_b64 s[2:3], s[6:7], 2
; GFX12-NEXT:    s_wait_kmcnt 0x0
