...
; GCN-NEXT:    s_load_b64 s[6:7], s[4:5], 0x3c nv
...
; GCN-NEXT:  ; %bb.10: ; %bb
; GCN-NEXT:    s_get_pc_i64 s[12:13]
; GCN-NEXT:  .Lpost_getpc14:
; GCN-NEXT:    s_add_co_u32 s12, s12, (.LBB10_4-.Lpost_getpc14)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s13, s13, (.LBB10_4-.Lpost_getpc14)>>32
; GCN-NEXT:    s_set_pc_i64 s[12:13]
; GCN-NEXT:  .LBB10_1: ; %Flow
; GCN-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s9
; GCN-NEXT:    s_cbranch_vccnz .LBB10_2
; GCN-NEXT:  ; %bb.12: ; %Flow
; GCN-NEXT:    s_get_pc_i64 s[10:11]
; GCN-NEXT:  .Lpost_getpc15:
; GCN-NEXT:    s_add_co_u32 s10, s10, (.LBB10_5-.Lpost_getpc15)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_5-.Lpost_getpc15)>>32
; GCN-NEXT:    s_set_pc_i64 s[10:11]
; GCN-NEXT:  .LBB10_2: ; %Flow6
; GCN-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
; GCN-NEXT:    s_cbranch_vccz .LBB10_3
; GCN-NEXT:  ; %bb.14: ; %Flow6
; GCN-NEXT:    s_get_pc_i64 s[0:1]
...
; GCN-NEXT:    s_add_co_u32 s10, s10, (.LBB10_2-.Lpost_getpc17)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_2-.Lpost_getpc17)>>32
; GCN-NEXT:    s_set_pc_i64 s[10:11]
...
; GCN-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GCN-NEXT:    s_and_b32 s0, s9, s0
; GCN-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
; GCN-NEXT:    s_cbranch_vccnz .LBB10_6
; GCN-NEXT:  ; %bb.18: ; %bb9
; GCN-NEXT:    s_get_pc_i64 s[10:11]
; GCN-NEXT:  .Lpost_getpc18:
; GCN-NEXT:    s_add_co_u32 s10, s10, (.LBB10_3-.Lpost_getpc18)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_3-.Lpost_getpc18)>>32
; GCN-NEXT:    s_set_pc_i64 s[10:11]
; GCN-NEXT:  .LBB10_6:
...
; GCN-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GCN-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NEXT:    s_lshl_b64 s[2:3], s[6:7], 2
; GCN-NEXT:    s_wait_kmcnt 0x0
...
; GCN-ADD-PC64-NEXT:    s_load_b64 s[6:7], s[4:5], 0x3c nv
; GCN-ADD-PC64-NEXT:    s_mov_b32 s9, -1
; GCN-ADD-PC64-NEXT:    s_wait_kmcnt 0x0
; GCN-ADD-PC64-NEXT:    s_cmp_eq_u32 s0, 0
; GCN-ADD-PC64-NEXT:    s_cselect_b32 s8, -1, 0
; GCN-ADD-PC64-NEXT:    s_cmp_lg_u32 s0, 0
; GCN-ADD-PC64-NEXT:    s_mov_b32 s0, 0
; GCN-ADD-PC64-NEXT:    s_cselect_b32 s10, -1, 0
...
; GCN-ADD-PC64-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s9
...
; GCN-ADD-PC64-NEXT:  .LBB10_2: ; %Flow6
; GCN-ADD-PC64-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
; GCN-ADD-PC64-NEXT:    s_cbranch_vccz .LBB10_3
; GCN-ADD-PC64-NEXT:  ; %bb.14: ; %Flow6
...
; GCN-ADD-PC64-NEXT:    s_and_b32 s0, s8, s0
; GCN-ADD-PC64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GCN-ADD-PC64-NEXT:    ;;#ASMEND
; GCN-ADD-PC64-NEXT:    s_sleep 0
; GCN-ADD-PC64-NEXT:    s_mov_b32 s0, s10
; GCN-ADD-PC64-NEXT:    s_sleep 0
...
; GCN-ADD-PC64-NEXT:    s_cselect_b32 s9, -1, 0
; GCN-ADD-PC64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GCN-ADD-PC64-NEXT:    s_and_b32 s0, s9, s0
; GCN-ADD-PC64-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
...
; GCN-ADD-PC64-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 nv
; GCN-ADD-PC64-NEXT:    v_mov_b32_e32 v1, 0
; GCN-ADD-PC64-NEXT:    s_lshl_b64 s[2:3], s[6:7], 2
; GCN-ADD-PC64-NEXT:    s_wait_kmcnt 0x0
; GCN-ADD-PC64-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
