...
define <2 x i1> @extract_subvec_mixed_to_pos_isneg_false(<4 x float> %a) {
; CHECK-LABEL: extract_subvec_mixed_to_pos_isneg_false:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-NEXT:    vfabs.v v8, v8
; CHECK-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
...
define <2 x i1> @extract_subvec_straddle_isneg_unknown(<4 x float> %a) {
; CHECK-LABEL: extract_subvec_straddle_isneg_unknown:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-NEXT:    vfabs.v v8, v8
...
define <4 x i1> @insert_subvec_pos_base_neg_sub_isneg_unknown(<4 x float> %base, <2 x float> %sub) {
; CHECK-LABEL: insert_subvec_pos_base_neg_sub_isneg_unknown:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-NEXT:    vfabs.v v8, v8
; CHECK-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
...
define <4 x i1> @insert_subvec_pos_base_pos_sub_isneg_false(<4 x float> %base, <2 x float> %sub) {
; CHECK-LABEL: insert_subvec_pos_base_pos_sub_isneg_false:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-NEXT:    vfabs.v v8, v8
; CHECK-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
