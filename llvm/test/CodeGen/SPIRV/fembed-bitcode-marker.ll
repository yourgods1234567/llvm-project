...
; RUN: %if spirv-tools %{ llc -verify-machineinstrs -mtriple=spirv64-unknown-unknown %s -o - -filetype=obj | spirv-val %}
; RUN: %if spirv-tools %{ llc -verify-machineinstrs -mtriple=spirv64-amd-amdhsa %s -o - -filetype=obj | spirv-val %}
;
