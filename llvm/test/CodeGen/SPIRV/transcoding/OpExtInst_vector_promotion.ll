; RUN: llc -verify-machineinstrs -O0 -mtriple=spirv32-unknown-unknown < %s | FileCheck %s
; RUN: %if spirv-tools %{ llc -verify-machineinstrs -O0 -mtriple=spirv32-unknown-unknown < %s -filetype=obj | spirv-val %}
;
