...
; RUN: %if spirv-tools %{ llc -verify-machineinstrs -O2 -mtriple=spirv64-unknown-unknown %s -o - -filetype=obj | spirv-val %}

; RUN: llc -verify-machineinstrs -O2 -mtriple=spirv32-unknown-unknown %s -o - | FileCheck %s
; RUN: %if spirv-tools %{ llc -verify-machineinstrs -O2 -mtriple=spirv32-unknown-unknown %s -o - -filetype=obj | spirv-val %}
