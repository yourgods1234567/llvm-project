...
; CHECK-NEXT:    [[TMP7:%.*]] = bitcast i32 [[TMP2]] to <2 x i16>
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <2 x i16> [[TMP7]], i32 0
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i16> poison, i16 [[TMP8]], i32 0
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <2 x i16> [[TMP7]], i32 1
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <4 x i16> [[TMP9]], i16 [[TMP10]], i32 1
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <2 x i16> [[TMP5]], i32 0
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x i16> [[TMP11]], i16 [[TMP12]], i32 2
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <2 x i16> [[TMP5]], i32 1
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <4 x i16> [[TMP13]], i16 [[TMP14]], i32 3
; CHECK-NEXT:    store <4 x i16> [[TMP15]], ptr addrspace(2) [[STORE_GEP1]], align 4
; CHECK-NEXT:    [[STORE_GEP3:%.*]] = getelementptr inbounds float, ptr addrspace(2) [[PTR2]], i64 2
; CHECK-NEXT:    [[TMP16:%.*]] = bitcast float [[TMP6]] to <4 x i8>
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <4 x i8> [[TMP16]], i32 0
; CHECK-NEXT:    [[TMP18:%.*]] = insertelement <8 x i8> poison, i8 [[TMP17]], i32 0
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <4 x i8> [[TMP16]], i32 1
; CHECK-NEXT:    [[TMP20:%.*]] = insertelement <8 x i8> [[TMP18]], i8 [[TMP19]], i32 1
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <4 x i8> [[TMP16]], i32 2
; CHECK-NEXT:    [[TMP22:%.*]] = insertelement <8 x i8> [[TMP20]], i8 [[TMP21]], i32 2
; CHECK-NEXT:    [[TMP23:%.*]] = extractelement <4 x i8> [[TMP16]], i32 3
; CHECK-NEXT:    [[TMP24:%.*]] = insertelement <8 x i8> [[TMP22]], i8 [[TMP23]], i32 3
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <4 x i8> [[LOAD44]], i32 0
; CHECK-NEXT:    [[TMP26:%.*]] = insertelement <8 x i8> [[TMP24]], i8 [[TMP25]], i32 4
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <4 x i8> [[LOAD44]], i32 1
; CHECK-NEXT:    [[TMP28:%.*]] = insertelement <8 x i8> [[TMP26]], i8 [[TMP27]], i32 5
; CHECK-NEXT:    [[TMP29:%.*]] = extractelement <4 x i8> [[LOAD44]], i32 2
; CHECK-NEXT:    [[TMP30:%.*]] = insertelement <8 x i8> [[TMP28]], i8 [[TMP29]], i32 6
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <4 x i8> [[LOAD44]], i32 3
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <8 x i8> [[TMP30]], i8 [[TMP31]], i32 7
; CHECK-NEXT:    store <8 x i8> [[TMP32]], ptr addrspace(2) [[STORE_GEP3]], align 4
; CHECK-NEXT:    ret void
;
