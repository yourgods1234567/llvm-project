...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr [4096 x half], ptr [[INPUT1]], i64 0, i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr [4096 x half], ptr [[INPUT2]], i64 0, i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr [4096 x half], ptr [[OUTPUT]], i64 0, i64 [[INDEX]]
...
; ZVFHMIN-NEXT:    [[TMP13:%.*]] = getelementptr [4096 x half], ptr [[INPUT1]], i64 0, i64 [[INDEX]]
...
; ZVFHMIN-NEXT:    [[TMP15:%.*]] = getelementptr [4096 x half], ptr [[INPUT2]], i64 0, i64 [[INDEX]]
...
; ZVFHMIN-NEXT:    [[TMP18:%.*]] = getelementptr [4096 x half], ptr [[OUTPUT]], i64 0, i64 [[INDEX]]
