...
; IF-EVL-OUTLOOP-NEXT:    [[TMP7:%.*]] = getelementptr i16, ptr [[X:%.*]], i32 [[EVL_BASED_IV]]
...
; IF-EVL-INLOOP-NEXT:    [[TMP8:%.*]] = getelementptr i16, ptr [[X:%.*]], i32 [[EVL_BASED_IV]]
...
; IF-EVL-OUTLOOP-NEXT:    [[TMP11:%.*]] = getelementptr i32, ptr [[A:%.*]], i64 [[EVL_BASED_IV]]
...
; IF-EVL-INLOOP-NEXT:    [[TMP11:%.*]] = getelementptr i32, ptr [[A:%.*]], i64 [[EVL_BASED_IV]]
