...
; SCALABLE-NEXT:    [[TMP8:%.*]] = getelementptr i64, ptr [[A]], i64 [[INDEX]]
...
; TF-SCALABLE-NEXT:    [[TMP7:%.*]] = getelementptr i64, ptr [[A]], i64 [[INDEX]]
...
; TF-SCALABLE-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <vscale x 2 x i64> [[BROADCAST_SPLATINSERT]], <vscale x 2 x i64> poison, <vscale x 2 x i32> zeroinitializer
; TF-SCALABLE-NEXT:    [[ARRAYIDX:%.*]] = getelementptr i64, ptr [[A]], i64 [[IV]]
...
; SCALABLE-NEXT:    [[TMP12:%.*]] = getelementptr i64, ptr [[A]], i64 [[INDEX]]
...
; TF-SCALABLE-NEXT:    [[TMP12:%.*]] = getelementptr i64, ptr [[A]], i64 [[INDEX]]
...
; SCALABLE-NEXT:    [[TMP7:%.*]] = getelementptr i64, ptr [[A]], i64 [[INDEX]]
...
; TF-SCALABLE-NEXT:    [[TMP6:%.*]] = getelementptr i64, ptr [[A]], i64 [[INDEX]]
...
; SCALABLE-NEXT:    [[TMP16:%.*]] = getelementptr i64, ptr [[A]], i64 [[TMP10]]
...
; TF-SCALABLE-NEXT:    [[TMP10:%.*]] = getelementptr i64, ptr [[A]], i64 [[INDEX]]
