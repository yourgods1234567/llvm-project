...
; RV64-NEXT:    [[TMP8:%.*]] = getelementptr i32, ptr [[B]], i64 [[TMP1]]
...
; RV64-NEXT:    [[TMP15:%.*]] = getelementptr i32, ptr [[A]], i64 [[TMP1]]
...
; RV32-NEXT:    [[TMP8:%.*]] = getelementptr i32, ptr [[B]], i64 [[TMP1]]
...
; RV32-NEXT:    [[TMP16:%.*]] = getelementptr i32, ptr [[A]], i64 [[TMP1]]
...
; RV64-NEXT:    [[TMP21:%.*]] = add i32 [[OFFSET_IDX]], -1
; RV64-NEXT:    [[TMP22:%.*]] = zext i32 [[TMP21]] to i64
; RV64-NEXT:    [[TMP23:%.*]] = getelementptr i32, ptr [[B]], i64 [[TMP22]]
...
; RV64-NEXT:    [[TMP30:%.*]] = getelementptr i32, ptr [[A]], i64 [[TMP22]]
...
; RV32-NEXT:    [[TMP13:%.*]] = add i32 [[OFFSET_IDX]], -1
; RV32-NEXT:    [[TMP14:%.*]] = zext i32 [[TMP13]] to i64
; RV32-NEXT:    [[TMP15:%.*]] = getelementptr i32, ptr [[B]], i64 [[TMP14]]
...
; RV32-NEXT:    [[TMP23:%.*]] = getelementptr i32, ptr [[A]], i64 [[TMP14]]
...
; RV64-NEXT:    [[TMP21:%.*]] = add i32 [[OFFSET_IDX]], -1
; RV64-NEXT:    [[TMP22:%.*]] = zext i32 [[TMP21]] to i64
; RV64-NEXT:    [[TMP23:%.*]] = getelementptr float, ptr [[B]], i64 [[TMP22]]
; RV64-NEXT:    [[TMP36:%.*]] = zext i32 [[TMP20]] to i64
; RV64-NEXT:    [[TMP17:%.*]] = sub nuw nsw i64 [[TMP36]], 1
; RV64-NEXT:    [[TMP18:%.*]] = sub i64 0, [[TMP17]]
...
; RV64-NEXT:    [[TMP30:%.*]] = getelementptr float, ptr [[A]], i64 [[TMP22]]
...
; RV32-NEXT:    [[TMP13:%.*]] = add i32 [[OFFSET_IDX]], -1
; RV32-NEXT:    [[TMP14:%.*]] = zext i32 [[TMP13]] to i64
; RV32-NEXT:    [[TMP15:%.*]] = getelementptr float, ptr [[B]], i64 [[TMP14]]
; RV32-NEXT:    [[TMP9:%.*]] = sub nuw nsw i32 [[TMP16]], 1
; RV32-NEXT:    [[TMP10:%.*]] = sub i32 0, [[TMP9]]
...
; RV32-NEXT:    [[TMP23:%.*]] = getelementptr float, ptr [[A]], i64 [[TMP14]]
...
; RV64-NEXT:    [[OFFSET_IDX:%.*]] = sub i64 1023, [[INDEX]]
; RV64-NEXT:    [[TMP1:%.*]] = add i64 [[OFFSET_IDX]], -1
; RV64-NEXT:    [[TMP8:%.*]] = getelementptr float, ptr [[B]], i64 [[TMP1]]
; RV64-NEXT:    [[TMP22:%.*]] = zext i32 [[TMP19]] to i64
; RV64-NEXT:    [[TMP4:%.*]] = sub nuw nsw i64 [[TMP22]], 1
; RV64-NEXT:    [[TMP5:%.*]] = sub i64 0, [[TMP4]]
...
; RV64-NEXT:    [[TMP15:%.*]] = getelementptr float, ptr [[A]], i64 [[TMP1]]
...
; RV32-NEXT:    [[OFFSET_IDX:%.*]] = sub i64 1023, [[INDEX]]
; RV32-NEXT:    [[TMP1:%.*]] = add i64 [[OFFSET_IDX]], -1
; RV32-NEXT:    [[TMP8:%.*]] = getelementptr float, ptr [[B]], i64 [[TMP1]]
; RV32-NEXT:    [[TMP3:%.*]] = sub nuw nsw i32 [[TMP9]], 1
; RV32-NEXT:    [[TMP4:%.*]] = sub i32 0, [[TMP3]]
...
; RV32-NEXT:    [[TMP16:%.*]] = getelementptr float, ptr [[A]], i64 [[TMP1]]
