...
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr [4 x i8], ptr [[A:%.*]], i32 [[TMP3]]
...
; CHECK-NEXT:    [[TMP32:%.*]] = getelementptr [4 x i8], ptr [[A:%.*]], i32 [[TMP31]]
; CHECK-NEXT:    [[TMP38:%.*]] = call <4 x i32> @llvm.masked.load.v4i32.p0(ptr align 4 [[TMP32]], <4 x i1> [[TMP0]], <4 x i32> poison)
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr [4 x i8], ptr [[B:%.*]], i32 [[TMP31]]
...
; CHECK-NEXT:    [[VEC_IV:%.*]] = or disjoint <4 x i32> [[BROADCAST_SPLAT]], <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP0:%.*]] = icmp ult <4 x i32> [[VEC_IV]], splat (i32 257)
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr [4 x i8], ptr [[A:%.*]], i32 [[TMP6]]
; CHECK-NEXT:    [[TMP38:%.*]] = call <4 x i32> @llvm.masked.load.v4i32.p0(ptr align 4 [[TMP1]], <4 x i1> [[TMP0]], <4 x i32> poison)
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr [4 x i8], ptr [[B:%.*]], i32 [[TMP6]]
