...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr [4 x i8], ptr [[X:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr [2 x i8], ptr [[X:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[X:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = call <4 x i1> @llvm.get.active.lane.mask.v4i1.i32(i32 [[INDEX]], i32 [[N]])
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr [4 x i8], ptr [[X:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr [4 x i8], ptr [[Y:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr [2 x i8], ptr [[X:%.*]], i32 [[INDEX]]
; CHECK-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <8 x i16> @llvm.masked.load.v8i16.p0(ptr align 2 [[TMP0]], <8 x i1> [[ACTIVE_LANE_MASK]], <8 x i16> poison)
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr [2 x i8], ptr [[Y:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[X:%.*]], i32 [[INDEX]]
; CHECK-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <16 x i8> @llvm.masked.load.v16i8.p0(ptr align 1 [[TMP0]], <16 x i1> [[ACTIVE_LANE_MASK]], <16 x i8> poison)
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[Y:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = call <8 x i1> @llvm.get.active.lane.mask.v8i1.i32(i32 [[INDEX]], i32 [[N]])
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr [2 x i8], ptr [[X:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr [2 x i8], ptr [[Y:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[X:%.*]], i32 [[INDEX]]
; CHECK-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <16 x i8> @llvm.masked.load.v16i8.p0(ptr align 1 [[TMP0]], <16 x i1> [[ACTIVE_LANE_MASK]], <16 x i8> poison)
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[Y:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = call <16 x i1> @llvm.get.active.lane.mask.v16i1.i32(i32 [[INDEX]], i32 [[N]])
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[X:%.*]], i32 [[INDEX]]
; CHECK-NEXT:    [[WIDE_MASKED_LOAD1:%.*]] = call <16 x i8> @llvm.masked.load.v16i8.p0(ptr align 1 [[TMP1]], <16 x i1> [[ACTIVE_LANE_MASK]], <16 x i8> poison)
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[Y:%.*]], i32 [[INDEX]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[B:%.*]], i32 [[INDEX]]
