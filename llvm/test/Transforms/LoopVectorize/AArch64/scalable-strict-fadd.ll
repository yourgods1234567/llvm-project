...
; CHECK-ORDERED-TF-NEXT:    [[TMP2:%.*]] = getelementptr float, ptr [[A]], i64 [[INDEX]]
...
; CHECK-ORDERED-TF-NEXT:    [[TMP6:%.*]] = getelementptr float, ptr [[TMP5]], i64 [[TMP1]]
; CHECK-ORDERED-TF-NEXT:    [[TMP7:%.*]] = getelementptr float, ptr [[TMP5]], i64 [[TMP3]]
; CHECK-ORDERED-TF-NEXT:    [[TMP8:%.*]] = getelementptr float, ptr [[TMP5]], i64 [[TMP4]]
...
; CHECK-ORDERED-TF-NEXT:    [[TMP5:%.*]] = getelementptr float, ptr [[B]], i64 [[OFFSET_IDX]]
...
; CHECK-ORDERED-TF-NEXT:    [[TMP12:%.*]] = extractelement <vscale x 4 x i1> [[ACTIVE_LANE_MASK_NEXT]], i64 0
...
; CHECK-ORDERED-TF-NEXT:    [[TMP3:%.*]] = getelementptr float, ptr [[A]], i64 [[INDEX]]
...
; CHECK-ORDERED-TF-NEXT:    [[TMP4:%.*]] = getelementptr float, ptr [[B]], i64 [[INDEX]]
...
; CHECK-ORDERED-TF-NEXT:    [[TMP2:%.*]] = getelementptr float, ptr [[B]], i64 [[INDEX]]
...
; CHECK-ORDERED-TF-NEXT:    [[WIDE_MASKED_LOAD8:%.*]] = call <vscale x 8 x float> @llvm.masked.load.nxv8f32.p0(ptr align 4 [[TMP7]], <vscale x 8 x i1> [[ACTIVE_LANE_MASK5]], <vscale x 8 x float> poison)
; CHECK-ORDERED-TF-NEXT:    [[WIDE_MASKED_LOAD9:%.*]] = call <vscale x 8 x float> @llvm.masked.load.nxv8f32.p0(ptr align 4 [[TMP8]], <vscale x 8 x i1> [[ACTIVE_LANE_MASK6]], <vscale x 8 x float> poison)
; CHECK-ORDERED-TF-NEXT:    [[TMP9:%.*]] = getelementptr float, ptr [[B]], i64 [[INDEX]]
; CHECK-ORDERED-TF-NEXT:    [[TMP10:%.*]] = getelementptr float, ptr [[TMP9]], i64 [[TMP1]]
; CHECK-ORDERED-TF-NEXT:    [[TMP11:%.*]] = getelementptr float, ptr [[TMP9]], i64 [[TMP3]]
; CHECK-ORDERED-TF-NEXT:    [[TMP12:%.*]] = getelementptr float, ptr [[TMP9]], i64 [[TMP4]]
