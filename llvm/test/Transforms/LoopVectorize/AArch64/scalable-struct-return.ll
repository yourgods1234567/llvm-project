...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr float, ptr [[IN]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr float, ptr [[OUT_A]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr float, ptr [[OUT_B]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr double, ptr [[IN]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr double, ptr [[OUT_A]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr double, ptr [[OUT_B]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = phi <vscale x 4 x i1> [ [[ACTIVE_LANE_MASK_ENTRY]], %[[VECTOR_PH]] ], [ [[ACTIVE_LANE_MASK_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr float, ptr [[IN]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr float, ptr [[OUT_A]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr float, ptr [[OUT_B]], i64 [[INDEX]]
