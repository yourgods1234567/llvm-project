...
; CHECK-UF1-NEXT:    [[TMP4:%.*]] = getelementptr i32, ptr [[DST]], i64 [[INDEX]]
...
; CHECK-UF4-NEXT:    [[TMP8:%.*]] = getelementptr i32, ptr [[DST]], i64 [[INDEX]]
; CHECK-UF4-NEXT:    [[TMP17:%.*]] = getelementptr i32, ptr [[TMP8]], i64 4
; CHECK-UF4-NEXT:    [[TMP18:%.*]] = getelementptr i32, ptr [[TMP8]], i64 8
; CHECK-UF4-NEXT:    [[TMP19:%.*]] = getelementptr i32, ptr [[TMP8]], i64 12
